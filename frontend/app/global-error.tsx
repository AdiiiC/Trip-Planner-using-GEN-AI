...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ background: "var(--bg)", color: "var(--fg)", fontFamily: "system-ui, sans-serif", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", margin: 0 }}>
        <div style={{ textAlign: "center", padding: "2rem", maxWidth: 400 }}>
          ...
          <p style={{ color: "var(--fg-muted)", fontSize: "0.875rem", marginBottom: 24 }}>
